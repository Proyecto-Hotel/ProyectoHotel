...
Public Class Usuarios
    ...
    Private Sub BtnAgregar_Click(sender As Object, e As EventArgs) Handles BtnAgregar.Click
        ...
        If txtIdentidad.Text = "" Or txtIdentidad.Text = "" Or cmbTipo.Text = "" Or txtNombre.Text = "" Or txtIdentidad.Text = "" Then
            MessageBox.Show("Debe llenar todas las casillas ", "Error")
            Exit Sub
        End If
        Dim UserName, Password, Identidad, TipoU As String

        UserName = txtIdentidad.Text
    ...
    Private Sub BtnBuscar_Click(sender As Object, e As EventArgs) Handles BtnBuscar.Click
        If txtIdentidad.Text = "" Or txtIdentidad.Text = "" Then
