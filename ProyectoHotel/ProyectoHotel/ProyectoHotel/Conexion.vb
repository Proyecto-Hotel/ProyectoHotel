...
Public Class Conexion
    Public conexion As SqlConnection = New SqlConnection("Data Source=LAPTOP-L0NU1VSF\;Initial Catalog=ProyectoHotel;Integrated Security=True")
    ...
    Public Function InsertarUsuario(userName As String, Psw As String, Identidad As String, TipoEmpleado As String) As Boolean
        Try
            ...
            cmd.Parameters.AddWithValue("@psw", Encrypt(Psw, "abc"))
            cmd.Parameters.AddWithValue("@Identidad", Identidad)
        ...
        End Try
    End Function
    Public Function InsertarReservacion(IdReservacion As Integer, FechaI As Date, FechaF As Date, CantidadDias As Integer, NumTarjeta As String, IdHuesped As Integer, IdHabitacion As Integer) As Boolean
        Try
            conexion.Open()
            Dim cmd As New SqlCommand("InsertarReservacion", conexion)
            cmd.CommandType = CommandType.StoredProcedure
            cmd.Parameters.AddWithValue("@IdReservacion", IdReservacion)
            cmd.Parameters.AddWithValue("@Puesto", FechaI)
            cmd.Parameters.AddWithValue("@Sueldo", FechaF)
            cmd.Parameters.AddWithValue("@CantidadDias", CantidadDias)
            cmd.Parameters.AddWithValue("@NumTarjeta", Encrypt(NumTarjeta, "abc"))
